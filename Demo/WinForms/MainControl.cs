...
namespace TheArtOfDev.HtmlRenderer.Demo.WinForms
{
    public partial class MainControl : UserControl
    {
        ...
        private void LoadSamples()
        {
            ...
            var printSamplesRoot = new TreeNode("Print Samples");
            _samplesTreeView.Nodes.Add(printSamplesRoot);
            ...
            foreach (var sample in SamplesLoader.PrintSamples)
            {
                AddTreeNode(printSamplesRoot, sample);
            }
