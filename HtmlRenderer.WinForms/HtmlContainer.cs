...
namespace TheArtOfDev.HtmlRenderer.WinForms
{
    ...
    public sealed class HtmlContainer : IDisposable
    {
        ...
        /// <summary>
        /// _pagelist is a list of RPage definitions.
        /// if _pagelist.Count is more than zero function RepositionLayoutToPageList is called to 
        /// layout elements inside drawing area of pages defined in _pagelist
        /// if there is not enaugh drawing space inside drawing area of pages defined in _pagelist 
        /// the last page in _pagelist is added automaticaly to _pagelist
        /// if _pagelist.Count is zero layout is performed as before.
        /// </summary>
